...
<ul>
  <li class="m1"><span>A <high>multi-class criterion</high> requires multiple output.</span></li>
  <li class="m2"><span><high>One-hot coding</high><br><br> 2 &rarr; 0, 1, 0, 0, 0<br> 5 &rarr; 0, 0, 0, 0, 1</span></li>
  <li class="m3"><span>The <high>softmax activation function</high> handles such cases.</span></li>
</ul>
...
<p align="center"><u>Categeorical cross-entropy</u></p>
...
<ul>
  ...
  <li class="m2"><span>The gradient expresses the <high>change in the Loss function</high> in due changes in the weights <mono>w</mono>.</span></li>
...
<u>Expected first moment(um)</u>

$$m_{t} = \beta_1 m_{t-1} + (1-\beta_1) \nabla_{w}$$

<u>Expected 2nd moment</u>
...
<ul>
  <li class="m1"><span>Neural networks can easily become <high>too flexible for good predictive accuracy</high>.</span></li><br>
  <li class="m2"><span>Ways to <high>control network flexibility</high>:</span></li><br>
  <ul>
    <li><span>Reduce depth / width</span></li><br>    
    <li><span>L1/L2 regularization<br><br>Increase loss proportional to magnitude of the weight.</span></li><br>
    <li><span>Dropout<br><br> Randomlyset the activation of nodes to 0.</span></li>
  </ul>
</ul>
...
<ul>
  <li class="m1"><span>The Modified National Institute of Standards and Technology database is best known for the <high>handwritten digit dataset</high>, the default traning data set for image recognition.</span></li><br>
  <li class="m2"><span>It contains <high>28x28px greyscale images</high> (features) and associated <high>integer labels</high> (criterion) indicating the <high>correct numbers.</span></li>
  </ul>
</ul>
...
<ul>
  <li class="m1"><span>For neural network modeling, features and criterion must be <high>transformed into the correct shapes</high>.</span></li><br>
  </ul>
</ul>
...
<ul>
  <li class="m1"><span><high>Convenient interface</high> for specifying deep neural networks using keras.</span></li>
  <li class="m2"><span>Allows <high>sequential build-up</high> of the network layer by layer.</span></li>
  <li class="m3"><span><highm>layer_dense</highm> is the most common of dozens of layer types.</span></li>
  </ul>
</ul>
