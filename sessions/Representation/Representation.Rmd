...
<ul>
  ...
  <li class="m2"><span>The activation patterns can easily be computed using basic <high>matrix algebra</high>, once the weights have been determined.</span></li>
</ul>
...
<ul>
  ...
  <li class="m3"><span>CNN are the <high>gold-standard</high> for image processing and <high>object recognition</high>.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Even though the activation patterns cannot be understood on their own, they can be used as an <high>alternative encoding or embedding of the inputs</high>.</span></li><br>
  <li class="m2"><span>Embeddings can be used to study the <high>relationship patterns</high> between inputs..</span></li>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Word embeddings represent an estimate of the (distributed) <high>meaning of a word</high>.</span></li>
